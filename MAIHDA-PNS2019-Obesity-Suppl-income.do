/*******************************************************************************
These are the codes for the supplemental figure 1 and table 1
...
The codes for the main paper and the supplemental figure 2 and table 2 can be 
...
/***************************************	
4.6 - Intersections of sex, race, income	
***************************************/
		
	mark nomiss1 
	markout nomiss1 agegroups sex race wage obesity
	ta nomiss1 if sample==1 // incomplete = 1,104 (1.51%)
	
	gen stratum1 = (1000*agegroups + 100*sex + 10*race + 1*wage) if sample==1 
	display 3*2*3*3 // 54
	codebook stratum1 // No stratas are missing
	ta stratum1

	label define intersection_label1 ///
		1111 "Younger Men White Low income" ///
		1112 "Younger Men White Mid income" ///
		1113 "Younger Men White High income" ///
		1121 "Younger Men Brown Low income" ///
		1122 "Younger Men Brown Mid income" ///
		1123 "Younger Men Brown High income" ///
		1131 "Younger Men Black Low income" ///
		1132 "Younger Men Black Mid income" ///
		1133 "Younger Men Black High income" ///
		1211 "Younger Women White Low income" ///
		1212 "Younger Women White Mid income" ///
		1213 "Younger Women White High income" ///
		1221 "Younger Women Brown Low income" ///
		1222 "Younger Women Brown Mid income" ///
		1223 "Younger Women Brown High income" ///
		1231 "Younger Women Black Low income" ///
		1232 "Younger Women Black Mid income" ///
		1233 "Younger Women Black High income" ///
		2111 "Middle-aged Men White Low income" ///
		2112 "Middle-aged Men White Mid income" ///
		2113 "Middle-aged Men White High income" ///
		2121 "Middle-aged Men Brown Low income" ///
		2122 "Middle-aged Men Brown Mid income" ///
		2123 "Middle-aged Men Brown High income" ///
		2131 "Middle-aged Men Black Low income" ///
		2132 "Middle-aged Men Black Mid income" ///
		2133 "Middle-aged Men Black High income" ///
		2211 "Middle-aged Women White Low income" ///
		2212 "Middle-aged Women White Mid income" ///
		2213 "Middle-aged Women White High income" ///
		2221 "Middle-aged Women Brown Low income" ///
		2222 "Middle-aged Women Brown Mid income" ///
		2223 "Middle-aged Women Brown High income" ///
		2231 "Middle-aged Women Black Low income" ///
		2232 "Middle-aged Women Black Mid income" ///
		2233 "Middle-aged Women Black High income" ///
		3111 "Older Men White Low income" ///
		3112 "Older Men White Mid income" ///
		3113 "Older Men White High income" ///
		3121 "Older Men Brown Low income" ///
		3122 "Older Men Brown Mid income" ///
		3123 "Older Men Brown High income" ///
		3131 "Older Men Black Low income" ///
		3132 "Older Men Black Mid income" ///
		3133 "Older Men Black High income" ///
		3211 "Older Women White Low income" ///
		3212 "Older Women White Mid income" ///
		3213 "Older Women White High income" ///
		3221 "Older Women Brown Low income" ///
		3222 "Older Women Brown Mid income" ///
		3223 "Older Women Brown High income" ///
		3231 "Older Women Black Low income" ///
		3232 "Older Women Black Mid income" ///
		3233 "Older Women Black High income" 
		label values stratum1 intersection_label1
...
//	Preparing the variable "sample" for the analysis
	drop sample
	gen sample1=.
	replace sample1=1 if V0015==1 & selected==1 & P005!=1 & C008>=18 & ///
		C008<=65 & BMI<60 & BMI>15 & stratum1!=. & nomiss1==1
...
// 	assigned a directory
		global MLwiN_path C:\(omitted)\mlwin.exe
...
* Null model
*************************************
	runmlwin obesity cons if sample1==1, ///
		level2(stratum1: cons,) ///
	...
	runmlwin obesity cons if sample1==1, ///
		level2(stratum1: cons, residuals(u)) ///
		level1(id:) ///
...
*************************************
	...
	runmlwin obesity cons mid older women brown black Imid Ihigh if sample1==1, ///
		level2(stratum1: cons,) ///
		level1(id:, weightvar(V00291)) ///
		discrete(distribution(binomial) link(logit) denominator(cons) pql2) ///
		nopause				
...
preserve
	...
	* interaction
	bysort stratum1: egen m2BpBsimlo = pctile(m2BpBsim), p(2.5)
	bysort stratum1: egen m2BpBsimhi = pctile(m2BpBsim), p(97.5)
	
	* Convert the data into a stratum-level dataset
	collapse (mean) m2BpBsim, by(stratum1 m2BpBsimlo m2BpBsimhi)
	...
	* effects in the logistic case 
	...
	list stratum1 m2Bpsimrank m2BpBsimlo m2BpBsimhi
	
	* Which intersectional stratas are above average? 
	count if m2BpBsimhi < 0 
	list stratum1 m2BpBsimhi m2BpBsimhi m2BpBsimlo m2Bpsimrank if m2BpBsimhi < 0 
	
	count if m2BpBsimlo > 0 
	list stratum1 m2BpBsimhi m2BpBsimhi m2BpBsimlo m2Bpsimrank if m2BpBsimlo > 0 
...
*******************************************************************************/
	...
	* Re-plot the caterpillar plot of the predicted stratum percentages with options
	list stratum1 m2Bprank if !missing(m2Bprank), abbreviate(16)
	...
	twoway ///
		...
		yline(0 10 20 30 40 50 60, lwidth(vthin) lcolor(gs13)) ///
		yline(20.94) ///
		yline(26.75, lcolor(gray) lpattern(dash)) ///
		yline(16.12, lcolor(gray) lpattern(dash)) ///	
...
*******************************************************************************/
	...
	* Generate list of 10 highest/lowest predicted stratum percentages (for Table 4)
	sort m2Bp
	extremes m2Bp m2Bplo m2Bphi stratum1 m2Bprank
	...
	* Which intersectional stratas are above average? 
	count if m2Bp > 20.94
	list stratum1 m2Bp m2Bplo m2Bphi m2Bprank if  m2Bp > 20.94
	...
	* Which intersectional strata have their highest 95% CI below the avg 95% CI?
	count if m2Bphi < 16.63
	list stratum1 m2Bp m2Bplo m2Bphi m2Bprank if m2Bphi<16.12 
	list stratum1 m2Bp m2Bplo m2Bphi m2Bprank if m2Bphi==16.12

	* Which intersectional strata have their lowest 95% CI above the avg 95% CI?
	count if m2Bplo > 26.75 
	list stratum1 m2Bp m2Bplo m2Bphi m2Bprank if m2Bplo > 26.75
	list stratum1 m2Bp m2Bplo m2Bphi m2Bprank if m2Bplo==26.75
